...
Const Z_min = 122
'----
Const T0_start1 = 106                                       'Ya que -->  256-150=106 (Cuenta 150 y desborda el T0)
...
Stop Adc
'----
Config Timer0 = Timer , Prescale = 8                        'Interrumpe --> 12000000/8/150=10000 (Frec/prescaler/timer1) int/seg
Stop Timer0                                                 'O sea, cada 100 useg
Timer0 = T0_start1                                          'Ya que -->  256-150=106 (Cuenta 150 y desborda el T0)
'----
...
'----
Config Timer3 = Timer , Prescale = 1                        'Interrumpe --> 12000000 int/seg
Stop Timer3
...
Sub Prt_help_com
   ...
   Print
   Print "ESC T <Intervalo> --> Habilita transmisión de datos continuo con retardo"
   Print "      Intervalo: (1 a 65535) x 100us"
   Print
...
Int_adc:
   ...
   Datos(canal + 1) = Datos(canal + 1) Or Aux_b
   Incr Canal
